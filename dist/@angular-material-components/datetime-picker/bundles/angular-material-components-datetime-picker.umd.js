(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/cdk/bidi'), require('@angular/cdk/coercion'), require('@angular/cdk/overlay'), require('rxjs/operators'), require('@angular/cdk/keycodes'), require('@angular/material/form-field'), require('rxjs'), require('@angular/cdk/portal'), require('@angular/material/datepicker'), require('@angular/material/dialog'), require('@angular/common'), require('@angular/forms'), require('@angular/material/button'), require('@angular/material/icon'), require('@angular/material/input'), require('@angular/material/core'), require('@angular/cdk/platform'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@angular-material-components/datetime-picker', ['exports', '@angular/cdk/bidi', '@angular/cdk/coercion', '@angular/cdk/overlay', 'rxjs/operators', '@angular/cdk/keycodes', '@angular/material/form-field', 'rxjs', '@angular/cdk/portal', '@angular/material/datepicker', '@angular/material/dialog', '@angular/common', '@angular/forms', '@angular/material/button', '@angular/material/icon', '@angular/material/input', '@angular/material/core', '@angular/cdk/platform', '@angular/core'], factory) :
    (factory((global['angular-material-components'] = global['angular-material-components'] || {}, global['angular-material-components']['datetime-picker'] = {}),global.ng.cdk.bidi,global.ng.cdk.coercion,global.ng.cdk.overlay,global.rxjs.operators,global.ng.cdk.keycodes,global.ng.material['form-field'],global.rxjs,global.ng.cdk.portal,global.ng.material.datepicker,global.ng.material.dialog,global.ng.common,global.ng.forms,global.ng.material.button,global.ng.material.icon,global.ng.material.input,global.ng.material.core,global.ng.cdk.platform,global.ng.core));
}(this, (function (exports,bidi,coercion,overlay,operators,keycodes,formField,rxjs,portal,datepicker,dialog,common,forms,button,icon,input,core,platform,core$1) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    exports.ɵa = NgxMatMonthView;
    exports.ɵc = NgxMatMultiYearView;
    exports.ɵb = NgxMatYearView;
